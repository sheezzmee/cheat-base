...
class BattleMap {
    isSpace = () => find(cheatBase.gameClasses.world, 'physicsScene.vector3.i:2')?.[1] === -300;
    ...
    getKillZone = () => {
        ...
        const mapBounds = find(cheatBase.gameClasses.world, 'physicsScene.collisionDetectorImpl.uniformGrid.aabb')?.[1];
